...
class ChuteONumero:
    # Função inicial para dar valor minimo e maximo e as variaveis necessarias
    def __init__(self):
    ...
    def Iniciar(self):
        ...
        #Chama a função iniciar novamente caso digite qualquer outra coisa que não seja um numero e Apresenta menssagem de erro.
        except:
